...
sampletweetsjsonfile = "./tests/sample.json"  # put here the path to where you placed the file e.g. ./sampletweets.json.
...
class TestTweetDfExtractor(unittest.TestCase):
    """
		A class for unit-testing function in the test_extract_dataframe.py file
    ...
    def test_find_full_text(self):
        ...
        text_original,_ = self.df.find_full_text()
        self.assertEqual(text_original, text)

    def test_find_sentiments(self):
        self.assertEqual(self.df.find_sentiments(self.df.find_full_text()), ([0,1], [-0.036363636363636355, 0.011111111111111106],
 [0.3443181818181818, 0.3541666666666667]))
